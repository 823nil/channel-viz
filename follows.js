(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'Pgg3z6XjX2BHJ8FA9ykoaqe24HiqCG2dCHSoWDzs7qMsHTbm', // Unique master Xively API key to be used as a default
		defaultFeeds	= [319333684], // Comma separated array of Xively Feed ID numbers
		applicationName	= '', // Replaces Xively logo in the header
		dataDuration	= '2Day', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
